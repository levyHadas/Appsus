...
function _createEmails() {
   ...
   var  email5 = _createExampleEmail(INBOX, 'whats up man?',lorem, Date.now(), 'Tal', '')
    ...
    emails.push(email9)
    var email10 = _createExampleEmail(INBOX, 'how much mail can one man write?', lorem, Date.now(), 'Hagar', '')
    emails.push(email10)
    var email11 = _createExampleEmail(INBOX, 'think about school', lorem, Date.now(), 'Guy', '')
    emails.push(email11)
    var email12 = _createExampleEmail(INBOX, 'can pigs fly?', lorem, Date.now(), 'Adi', '')
    emails.push(email12)
    var email13 = _createExampleEmail(INBOX, 'and how about an elephent?',lorem, Date.now(), 'Yanai', '')
    emails.push(email13)
    return emails
}
